...
public class SyntacticAnlysisTable {
    ...
    public String[][] tas = 
    {
     ...
     /*ELSE*/               {"", "", "ELSE -> E", "", "", "", "", "ELSE -> E", "ELSE -> E", "ELSE -> E", "", "", "", "", "", "", "", "", "", "", "", "ELSE -> E", "", "ELSE -> E","","","","","","", "ELSE -> IF-ELSE", "", ""},
     ...
     /*FOR*/                {"", "", "", "", "", "", "", "", "", "FOR -> for FORMA-FOR LL-CONTENIDO",  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
     /*FORMA-FOR*/          {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "FORMA-FOR -> FORMA-FOR' LL-CONTENIDO", "", "", "", "", "", "", "", ""},
     /*FORMA-FOR'*/         {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "FORMA-FOR' -> FORMA-FOR''", "", "", "", "", "", "", "", ""},
     ...
     /*DEC''*/              {"", "DEC'' -> = DEC'''", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
     /*DEC'''*/             {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "DEC''' -> val", "DEC''' -> id", "", "", "", "", "", "", "", "", "", "", ""},
     /*OP*/                 {"", "", "", "", "", "", "", "", "", "", "", "OP -> ; COMP-RELACION", "", "", "", "", "", "", "", "", "OP -> ; COMP-RELACION", "OP -> ; COMP-RELACION", "", "", "", "", "", "", "", "", "", "", ""},
     /*AU*/                 {"", "", "", "", "", "", "", "", "", "", "", "AU -> ; AU' MASMENOS", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
     /*AU'*/                {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "AU' -> id", "", "", "", "", "", "", "", "", "", "", ""},
